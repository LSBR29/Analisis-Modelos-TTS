...
\begin{document}
    ...
    Si realiza el entrenamiento de esta manera, luego deberá dirigirse a \url{https://www.kaggle.com/work} buscar su notebook e ingresar en la pestaña \textit{Output} para descargar los resultados del entrenamiento y subirlos a una nueva sesión como un modelo el cual utilizará para la inferencia.
